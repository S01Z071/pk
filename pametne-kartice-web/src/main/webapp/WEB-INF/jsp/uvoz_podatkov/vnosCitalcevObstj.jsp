...
<div class="container" style="text-align: center;">
    <div class="row">
        <div class="span10">
            <h4>Izbira datoteke s podatki o čitalcih</h4><br><br>
        </div>
    </div>
    <div class="row">
        <div class="error">
        ...
        <c:if test='${not empty neNajdenih && neNajdenih!=0}'>
            <div class="error">          
                Čitalcev, ki jih ni bilo mogoče povezati s šifro sodišča:${neNajdenih}<br>           
            </div><br>
        </c:if>   
    </div>
</div>
<br>
<div class="container">
    <form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/vnosCitalcevObstj/process">   
        <div class="row">
            <div class="span7">
        ...
        <table class="table">
             <tr>
                <td colspan="6" style="text-align:center;"><h4>Seznam čitalcev v bazi brez šifre sodišča (${fn:length(seznamCitalcevSigovca)})</h4></td>
            </tr>
            ...
            <c:forEach var="seznamCitalcevSigovca" items="${seznamCitalcevSigovca}">
                <tr>
                    ...
                    <td> <fmt:formatDate value="${seznamCitalcevSigovca.datumVrnitve}" pattern="dd.MM.yyyy" /></td>                  
                </tr>
            </c:forEach>  
        </table>
