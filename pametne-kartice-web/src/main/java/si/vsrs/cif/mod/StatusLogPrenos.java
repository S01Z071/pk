 ...
 */
@Entity
@Table(name = "STATUS_LOG_PRENOS")
public class StatusLogPrenos implements Serializable {
    ...
    private long zahtevekPrenosLID;
    @Column(name = "OPIS")
    private String opis;
    ...
    public long getZahtevekPrenosLID() {
        return zahtevekPrenosLID;
    }

    public void setZahtevekPrenosLID(long zahtevekPrenosLID) {
        this.zahtevekPrenosLID = zahtevekPrenosLID;
    }
